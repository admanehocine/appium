...
exports.config = {
    ...
    capabilities: [{
        ...
        */
        ...
        // 🔑 Identique à Appium Inspector
        'appium:udid': '7a5d8937',
        'appium:deviceName': 'Android',
        'appium:platformVersion': '15',

        // 📦 App déjà installée (PAS de app.apk)
        'appium:appPackage': 'com.appiumpro.the_app',
        'appium:appActivity': 'com.appiumpro.the_app.MainActivity',

        // 🚫 Ne pas réinstaller / ne pas nettoyer l’app
        'appium:noReset': true,
        'appium:fullReset': false,
        // 🔑 CLÉ ANDROID 15
        'appium:skipDeviceInitialization': true,
        // ⏱ Stabilité (Android 14 / 15)
        'appium:newCommandTimeout': 600,
        'appium:adbExecTimeout': 120000,

        // 🛡 Evite les crashes sur Android récent
        'appium:ignoreHiddenApiPolicyError': true,

        // ⚠️ OK car ça marche déjà chez toi
        //'appium:skipDeviceInitialization': true,
